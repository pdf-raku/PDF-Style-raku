...
isa-ok $pdf, PDF::Compose, 'PDF::Compose.new';
my $page = $pdf.page(1);
isa-ok $page, ::('PDF::Compose::Page'), 'got first page';

my $helvetica;
#lives-ok { 
$helvetica = PDF::Compose::Font.core-font('Helvetica'); #}, 'core font load - lives';
isa-ok $helvetica, ::('Font::Metrics::helvetica'), 'core font';
is $helvetica.FontName, 'Helvetica', 'font name';
is $helvetica.Weight, 'Medium', 'font weight';

my $tr-bold-italic;
lives-ok { $tr-bold-italic = PDF::Compose::Font.core-font('Times-Roman', :font-weight<bold>, :font-style<italic>); }, 'core font load - lives';
isa-ok $tr-bold-italic, ::('Font::Metrics::times-bolditalic'), 'core font';
